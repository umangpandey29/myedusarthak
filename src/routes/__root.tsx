...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MyEduSarthak — Hindi Report Card System" },
      { name: "description", content: "Create premium Hindi school report cards for classes 6–10. Auto-grading, cloud storage." },
    ],
